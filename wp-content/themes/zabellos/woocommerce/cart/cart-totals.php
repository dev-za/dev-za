...
<!--            Subtotal-->
            <tr id="cart-subtotal">
                <td class="text-muted "><?php _e( 'Subtotal', 'woocommerce' ); ?>:</td>
                <td><?php wc_cart_totals_subtotal_html(); ?></td>
            </tr>
            <?php foreach ( WC()->cart->get_coupons() as $code => $coupon ) : ?>
                <tr class="text-muted cart-discount coupon-<?php echo esc_attr( $code ); ?>">
...
<!--            Shipping-->
            ...
            <?php elseif ( WC()->cart->needs_shipping() ) : ?>
                ...
                <tr>
                    <td class="text-muted"><?php _e( 'Shipping', 'woocommerce' ); ?></td>
                ...
                <?php if ( get_option( 'woocommerce_tax_total_display' ) == 'itemized' ) : ?>
                    <?php foreach ( WC()->cart->get_tax_totals() as $code => $tax ) : ?>
                        <tr class="tax-rate tax-rate-<?php echo sanitize_title( $code ); ?>">
                            <td   class="text-muted"><?php echo esc_html( $tax->label ); ?></td>
                            <td><?php echo wp_kses_post( $tax->formatted_amount ); ?></td>
                        </tr>
                    <?php endforeach; ?>
                <?php else : ?>
                    <tr id="cart-tax-total" class="tax-total">
...
<!--            Order Total-->
            ...
            <tr id="cart-order-total">
                ...
                <td class="font-22"><strong><?php wc_cart_totals_order_total_html(); ?></strong></td>
            </tr>
